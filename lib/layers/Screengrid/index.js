...
var metadata = new _chart.ChartMetadata({
  ...
  description: '',
  name: (0, _translation.t)('deck.gl Screen Grid'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

var ScreengridChartPlugin = /*#__PURE__*/function (_ChartPlugin) {
  _inheritsLoose(ScreengridChartPlugin, _ChartPlugin);

  function ScreengridChartPlugin() {
    return _ChartPlugin.call(this, {
      loadChart: function loadChart() {
        return Promise.resolve().then(function () {
          return _interopRequireWildcard(require('./Screengrid'));
        });
      },
      metadata: metadata,
  ...
  return ScreengridChartPlugin;
}(_chart.ChartPlugin);

exports.default = ScreengridChartPlugin;